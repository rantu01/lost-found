...
import { signUpWithEmail, signInWithGooglePopup } from '../../../lib/firebase'
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4 font-sans">
      <div className="bg-white w-full max-w-[450px] rounded-2xl shadow-sm border border-gray-100 p-8 md:p-10">
        ...
        <p className="text-center text-sm text-gray-500 mt-6">Already have an account? <Link href="/login" className="font-bold text-blue-600">Login</Link></p>
      </div>
    </div>
  )
}
